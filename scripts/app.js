...
(function() {
  ...
  imgTo.gray = function(imgData){
    ...
    return {imgData, title: "Image Keabuan"};
  }
  ...
  imgTo.bin = function(imgData){
    ...
    return {imgData, title: "Image Biner"};
  ...
  imgTo.inv = function(imgData){
    ...
    return {imgData, title: "Image Inversi"};
  }
  ...
  imgTo.sepia = function(imgData){
    ...
    return {imgData, title: "Image Sepia"};
  }
  ...
  imgTo.solar = function(imgData){
    ...
    return {imgData, title: "Image Solarize"};
  }
  ...
  var app = {
    ...
    btnDownload: document.getElementById('butDownload'),
  ...
  // app.btnDownload.addEventListener('click', function(imgFile) {
  //   app.myImg.setAttribute('download', '-edited');
  // })
  ...
  app.init = function() {
    app.myImg.setAttribute('src', 'images/ashcircle.png');
  }
  app.init();
